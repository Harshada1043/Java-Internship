...
class TicTacToeGameinSwing implements ActionListener
{
    ...
    TicTacToeGameinSwing()
    {
        ...
        frame.getContentPane().setBackground(new Color(222, 80, 156));
        frame.setTitle("Tic Tac Toe Game");
        frame.setLayout(new BorderLayout());
        frame.setVisible(true);

        textfield.setBackground(new Color(60,11,77));
        textfield.setForeground(new Color(240,224,0));
    ...
    {
        bton[x1].setBackground(Color.cyan);
        bton[x2].setBackground(Color.cyan);
        bton[x3].setBackground(Color.cyan);
        ...
        for (int i = 0; i < 9; i++)
        {
            if (e.getSource() == bton[i])
            {
                if (pl1_chance)
                {
                    if (bton[i].getText() == "")
                    {
                        bton[i].setForeground(new Color(90, 70, 155));
                        bton[i].setText("X");
                        pl1_chance = false;
                ...
                else
                {
                    if (bton[i].getText() == "")
                    {
                        bton[i].setForeground(new Color(255, 51, 119));
                        bton[i].setText("O");
                        pl1_chance = true;
